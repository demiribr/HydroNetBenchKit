#!/usr/bin/python
# -*- coding: utf-8 -*-
"""Create data structures for data models from CSV data (id, parent)"""
...
def read_data(file_name=DATA_FILE):
    """ Read source data into numpy array"""

    data = np.loadtxt(DATA_FOLDER + file_name,
...
def path_enumeration(data):
    ...
    #    print key, value
    with open(DATA_FOLDER + 'path_enumeration.csv', 'wb') as f:
